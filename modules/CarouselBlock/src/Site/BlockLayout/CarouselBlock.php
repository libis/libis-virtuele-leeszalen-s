<?php
namespace CarouselBlock\Site\BlockLayout;
...
class CarouselBlock extends AbstractBlockLayout
{
    public function getLabel()
    {
        return 'Libis - Carousel preview'; // @translate
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
        ...
        return $view->partial('common/block-layout/carousel-block', [
            'block' => $block,
